...
![1597501750467](/assert/1597501750467.png)
...
![1634132956478](/assert/1634132956478.png)

![1634133237935](/assert/1634133237935.png)
...
![1634465390843](/assert/1634465390843.png)
...
GET bank/_search?q=*&sort=account_number:asc
	q=*：查询所有
	sort=account_number:asc：根据account_number升序排列
	GET bank/_search?q=*&sort=account_number:asc
...
```json
模糊匹配-查询参数不会作分词操作，将mill lane作为整体进行模糊查询
GET bank/_search
{
  "query": {
    "match_phrase": {
...
![1634562010741](/assert/1634562010741.png)
...
```
 ...
 ![1634573322497](/assert/1634573322497.png)
...
![1634914895427](/assert/1634914895427.png)

方式2：Map<String, Object>

![1634914984175](/assert/1634914984175.png)

方式3：XContentBuilder（内容构造器）

![1634915043054](/assert/1634915043054.png)

方式4：

![1634915088215](/assert/1634915088215.png)
...
查询结果：
 ...
 ![1634920614495](/assert/1634920614495.png)
